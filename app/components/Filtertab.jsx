...
const DialobBox = () => (
                <Dialog.Root>
                  <Dialog.Trigger >
                    <button className='text-base font-bold px-[18px] py-3 rounded-lg text-white bg-tertiary'>Create</button>
                  </Dialog.Trigger>
                  <Dialog.Portal>
                    ...
                    <Dialog.Close asChild>
                      ...
                      <fieldset>
                        <input className='w-full px-5 py-3 text-sm font-normal border rounded-md outline-none' type="text" placeholder='Company Name' />
                      </fieldset>
                      <fieldset>
                        <input className='w-full px-5 py-3 text-sm font-normal border rounded-md outline-none' type="text" placeholder='Job Title' />
                      </fieldset>
                      <fieldset>
                        <input className='w-full px-5 py-3 text-sm font-normal border rounded-md outline-none' type="text" placeholder='Job URL' />
                      </fieldset>
                      <Select.Root defaultValue='saved'>
                        ...
                        <Select.Content className='bg-white shadow-md '>
                         <Select.Viewport className=''>
                          ...
                          <SelectItem value="saved1">Saved1</SelectItem>
                          <SelectItem value="saved2">Saved2</SelectItem>
                         </Select.Viewport>
                        </Select.Content>
                        </Select.Portal>
                      </Select.Root>
                      ...
                      <Dialog.Close asChild>
                        <button className="w-full p-4 text-base font-bold text-white rounded-md outline-none bg-tertiary">
                          Submit
                        </button>
                      </Dialog.Close>
                      </div>
                      <div className='flex p-[10px] bg-secondary gap-[10px] rounded-lg'>
                        ...
                        <p className='text-[10px] font-normal'>Did yoy know? You can save job directly from our Extension and have all the data imported in a simple  click! It takes just a few seconds</p>
                      </div>
                    </Dialog.Content>
                  </Dialog.Portal>
        ...
        <div className='flex items-center justify-between px-5 py-4'>
            ...
            <div className='flex gap-3'>
                <div className='flex items-center px-5 py-4 border rounded-lg cursor-pointer'>
                    ...
                    <input type="text" className='text-sm font-normal outline-none' placeholder='Search' />
                </div>
                <DialobBox />
            </div>
        </div>
